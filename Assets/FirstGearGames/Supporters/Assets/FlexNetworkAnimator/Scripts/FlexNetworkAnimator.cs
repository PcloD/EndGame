...
namespace FirstGearGames.Mirrors.Assets.FlexNetworkAnimators
{
    ...
    {
        public string[] ExcludeAnimParams;
        #region Types.
        ...
        private class ParameterDetail
        {
            ...
            /// <summary>
            /// string for the animator
            /// </summary>
            public string Name;

            public ParameterDetail(AnimatorControllerParameter controllerParameter, byte typeIndex, string name)
            {
        ...
        private void Initialize()
        {
            ...
            foreach (AnimatorControllerParameter item in _animator.parameters)
            {
                if (!_animator.IsParameterControlledByCurve(item.name))
                {
                    ...
                    _parameterDetails.Add(new ParameterDetail(item, (byte)typeIndex, item.name));
                }
            }
        }
